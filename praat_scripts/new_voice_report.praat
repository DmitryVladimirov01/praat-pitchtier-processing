####
# Этот скрипт является модифицированной версией скрипта voice-report из
...
form voice report
	...
	sentence Save_directory C:\praatoutput
...
for thisSelectedSounds to numberOfSelectedSounds
...
for thisSound from 1 to numberOfSelectedSounds
	...
	if draw_waveform_and_pitch_contour = 1
		...
		Save as 600-dpi PNG file: "'save_directory$'/'name$'.png"
	endif
